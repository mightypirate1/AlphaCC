...
use crate::tui::hex::backend::RenderBackend;
use crate::tui::hex::glyph_backend::GlyphBackend;
use crate::tui::hex::layers::{self, BoardView};
use crate::tui::hex::layout::HexLayout;
...
impl App {
    pub fn new(config: AppConfig) -> Self {
        ...
        use crate::tui::status_bar::EvalMode;
    ...
    fn scale_pi(&self, pi: &[f32]) -> Vec<f32> {
        use crate::tui::status_bar::PolicyScale;
    ...
    fn active_pi(&self) -> &[f32] {
        use crate::tui::status_bar::DataSource;
